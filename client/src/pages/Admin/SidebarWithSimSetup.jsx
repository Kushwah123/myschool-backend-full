  ...
  return (
    <div className="bg-dark text-white p-3" style={{ minHeight: '100vh', width: '100%', maxWidth: '250px' }}>
      ...
      <ul className="nav flex-column">
        ...
        <li className="nav-item mb-2">
          <Link to="/admin/whatsapp-settings" className="nav-link text-white fw-semibold">📞 SIM Calling Setup</Link>
        </li>
...
export default SidebarWithSimSetup;
